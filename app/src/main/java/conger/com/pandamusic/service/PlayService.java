...
import conger.com.pandamusic.application.Notifier;
...
import conger.com.pandamusic.receiver.NoisyAudioStreamReceiver;
import conger.com.pandamusic.utils.MusicUtils;
import conger.com.pandamusic.utils.Preferences;

import static conger.com.pandamusic.enums.PlayModeEnum.LOOP;
import static conger.com.pandamusic.enums.PlayModeEnum.SHUFFLE;
import static conger.com.pandamusic.enums.PlayModeEnum.SINGLE;
...
public class PlayService extends Service implements MediaPlayer.OnCompletionListener, AudioManager.OnAudioFocusChangeListener {
    ...
    public void updateMusicList() {
        ...
        AppCache.getInstance().updateAlbumList();
        AppCache.getInstance().updateArtistList();
